...
import InstagramSyncForm from "@/app/(pages)/(auth)/sync-account/instagram/components/InstagramSyncForm";

const SyncInstagramPage = () => {
  return (
    <div className="max-w-7xl px-4 mx-auto grid lg:grid-cols-2 gap-5 mt-10">
      <div className="flex flex-col space-y-8">
        ...
        <InstagramSyncForm></InstagramSyncForm>
        <div>
...
export default SyncInstagramPage;
