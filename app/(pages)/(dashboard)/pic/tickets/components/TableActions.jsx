...
import Comment from "@/app/(pages)/(dashboard)/pic/tickets/components/Comment";
import CommentInput from "@/app/(pages)/(dashboard)/pic/tickets/components/CommentInput";
...
const TableActions = ({ id }) => {
  return (
    <Sheet>
      ...
      <SheetContent className="lg:w-[540px] overflow-y-scroll">
        <SheetHeader>
